            ...
            switch (intResponse) {
                case 200:
                    try {
                        ...
                        Log.e("userId_CNICFrontAsync", userId);
                        ...
                        if (jsonObjNewAccount != null && !jsonObjNewAccount.isEmpty()) {
                            ...
                            base64CnicBack = jsonObject.getString("cnic_back_image");
                            Log.e("base64CnicBack", base64CnicBack);
                            ...
                            mParams.add(new BasicNameValuePair("imageposition", "cnic_back"));
